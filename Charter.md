...
The JellyChain1 project is part of the OpenJS Foundation which operates
...
JellyChain1 is a RPC-HTTP web server blockchain framework with a simple and expressive API Blockchain Database
...
in Node.js and JellyScript. As one of the most popular database frameworks in
...
Cross Project Council (CPC). In the case of the JellyChain1 project, it is
delegated to the JellyChain1 Technical Committee ("TC").
...
The JellyChain1 TC uses a "consensus seeking" process for issues that are
